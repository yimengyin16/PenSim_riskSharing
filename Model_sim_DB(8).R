...
i.r_supplement <- matrix(dr, 10, Global_paramlist$nsim + 3)
# i.r_supplement <-  
...
for (j in 1:nyear){
  ...
  # Calculate total benefit and AL
	...
	if(cola_type == "return"){
		...
		if(k %in% c(-1,-2) & restrictCOLAdet_cola_return & j >= (smoothYear_cola_return + s.year) ){
