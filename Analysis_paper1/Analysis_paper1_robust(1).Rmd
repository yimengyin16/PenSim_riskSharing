...
This script conduct sensitivity analysis for the impact of risk-sharing policies on employer and plan members


Return scenarios for sensitivity analysis:
- high volatility: SD = 14% 
- low volatility:  SD = 10%


Run control file: 
- RunControl_sensitivity.xlsx


Model outputs:
./Outputs_sensitivity/highVol
./Outputs_sensitivity/lowVol
...
# Get results for high volatility runs

dir_modelResults <- paste0(here::here(),"/Outputs_sensitivity/highVol/")
source(here::here("Analysis_loadingResults.R"))
results_highVol <- results_all


dir_modelResults <- paste0(here::here(),"/Outputs_sensitivity/lowVol/")
source(here::here("Analysis_loadingResults.R"))
results_lowVol <- results_all


dir_modelResults <- paste0(here::here(),"/Outputs/")
source(here::here("Analysis_loadingResults.R"))
results_midVol <- results_all

rm(results_all)

results_highVol$runname %>% unique
...
df_CAGR30_highVol <- get_CAGR(results_highVol, 30)
df_CAGR30_midVol  <- get_CAGR(results_midVol, 30)
df_CAGR30_lowVol  <- get_CAGR(results_lowVol, 30)

df_CAGR30_highVol$cutoff
df_CAGR30_midVol$cutoff
df_CAGR30_lowVol$cutoff
...
df_PVC_30y_highVol <- get_PVC(results_highVol, 30)
df_PVC_30y_midVol  <- get_PVC(results_midVol,  30)
df_PVC_30y_lowVol  <- get_PVC(results_lowVol,  30)
...
df_ERCMaxChg_30y_highVol <- get_ERCMaxChg(results_highVol, 30)
df_ERCMaxChg_30y_midVol  <- get_ERCMaxChg(results_midVol,  30)
df_ERCMaxChg_30y_lowVol  <- get_ERCMaxChg(results_lowVol,  30)
...
df_EECMaxChg_30y_highVol <- get_EECMaxChg(results_highVol, 30)
df_EECMaxChg_30y_midVol  <- get_EECMaxChg(results_midVol, 30)
df_EECMaxChg_30y_lowVol  <- get_EECMaxChg(results_lowVol, 30)
...
get_tbl_medERC <- function(df_PVC, df_CAGR, span, runs_select){
...
tbl_ERCmedian_midVol  <- get_tbl_medERC(df_PVC_30y_midVol,  df_CAGR30_midVol,  30, runs_paper)
tbl_ERCmedian_highVol <- get_tbl_medERC(df_PVC_30y_highVol, df_CAGR30_highVol, 30, runs_paper)
tbl_ERCmedian_lowVol  <- get_tbl_medERC(df_PVC_30y_lowVol,  df_CAGR30_lowVol,  30, runs_paper)


tbl_ERCmedian_highVol
tbl_ERCmedian_midVol
tbl_ERCmedian_lowVol
...
# Function
get_ERCvol_tbl <- function(df, df_CAGR, span = NULL, runnames_select){
...
tbl_ERCvol_y30_FR75_highVol <- get_ERCvol_tbl(df_ERCMaxChg_30y_highVol$ERCMaxChg, df_CAGR30_highVol, 30, runs_paper)
tbl_ERCvol_y30_FR75_midVol  <- get_ERCvol_tbl(df_ERCMaxChg_30y_midVol$ERCMaxChg, df_CAGR30_midVol, 30, runs_paper)
tbl_ERCvol_y30_FR75_lowVol  <- get_ERCvol_tbl(df_ERCMaxChg_30y_lowVol$ERCMaxChg, df_CAGR30_lowVol, 30, runs_paper)


tbl_ERCvol_y30_FR75_highVol$tbl
tbl_ERCvol_y30_FR75_midVol$tbl
tbl_ERCvol_y30_FR75_lowVol$tbl
...
# impacts are large on all policies, but does not change conclusion (relative strength of impact of different policies)

get_tbl_ERChike <- function(df){
...
tbl_ERChike_highVol <- get_tbl_ERChike(results_highVol)
tbl_ERChike_midVol  <- get_tbl_ERChike(results_midVol)
tbl_ERChike_lowVol  <- get_tbl_ERChike(results_lowVol)
...
## Table for PV EEC
```{r tab_EEC_PV, echo = FALSE}


get_pvEEC_tbl <- function(df_PVC, df_CAGR, span = NULL, runs_select){
...
tbl_pvEEC_y30_FR75_highVol <- get_pvEEC_tbl(df_PVC_30y_highVol, df_CAGR30_highVol, 30, runs_paper[c(1, 4:7)])
tbl_pvEEC_y30_FR75_midVol  <- get_pvEEC_tbl(df_PVC_30y_midVol,  df_CAGR30_midVol, 30, runs_paper[c(1, 4:7)])
tbl_pvEEC_y30_FR75_lowVol  <- get_pvEEC_tbl(df_PVC_30y_lowVol,  df_CAGR30_lowVol, 30, runs_paper[c(1, 4:7)])



tbl_pvEEC_y30_FR75_highVol$tbl
tbl_pvEEC_y30_FR75_midVol$tbl
tbl_pvEEC_y30_FR75_lowVol$tbl
...
```{r tab_EEC_vol1, echo = FALSE}

# Function
get_EECvol_tbl <- function(df, df_CAGR, span = NULL, runnames_select){
...
tbl_EECvol_y30_FR75_highVol <- get_EECvol_tbl(df_EECMaxChg_30y_highVol$EECMaxChg, df_CAGR30_highVol, 30, runs_paper[c(1, 4:7)])
tbl_EECvol_y30_FR75_midVol  <- get_EECvol_tbl(df_EECMaxChg_30y_midVol$EECMaxChg,  df_CAGR30_midVol,  30, runs_paper[c(1, 4:7)])
tbl_EECvol_y30_FR75_lowVol  <- get_EECvol_tbl(df_EECMaxChg_30y_lowVol$EECMaxChg,  df_CAGR30_lowVol,  30, runs_paper[c(1, 4:7)])

tbl_EECvol_y30_FR75_highVol$tbl 
tbl_EECvol_y30_FR75_midVol$tbl  
tbl_EECvol_y30_FR75_lowVol$tbl  
...
results_highVol <- add_hybridBen(results_highVol)
results_midVol  <- add_hybridBen(results_midVol)
results_lowVol  <- add_hybridBen(results_lowVol)
...
df_benefit_y30_highVol  <- get_benefit(results_highVol, start_year = 1, span = 30)
df_benefit_y30_midVol   <- get_benefit(results_midVol,  start_year = 1, span = 30)
df_benefit_y30_lowVol   <- get_benefit(results_lowVol,  start_year = 1, span = 30)
...
get_pvB_quintile <- function(df, df_CAGR, span){
...
tbl_pvB_y30_highVol <- get_pvB_quintile(df_benefit_y30_highVol, df_CAGR30_highVol, 30)
tbl_pvB_y30_midVol  <- get_pvB_quintile(df_benefit_y30_midVol,  df_CAGR30_midVol,  30)
tbl_pvB_y30_lowVol  <- get_pvB_quintile(df_benefit_y30_lowVol,  df_CAGR30_lowVol,  30)


tbl_pvB_y30_highVol$tbl
tbl_pvB_y30_midVol$tbl 
tbl_pvB_y30_lowVol$tbl 
...
get_Bvol_quintile <- function(df, df_CAGR, span){
...
tbl_Bvol_y30_highVol <- get_Bvol_quintile(df_benefit_y30_highVol, df_CAGR30_highVol, 30)
tbl_Bvol_y30_midVol  <- get_Bvol_quintile(df_benefit_y30_midVol,  df_CAGR30_midVol,  30)
tbl_Bvol_y30_lowVol  <- get_Bvol_quintile(df_benefit_y30_lowVol,  df_CAGR30_lowVol,  30)



tbl_Bvol_y30_highVol$tbl
tbl_Bvol_y30_midVol$tbl
tbl_Bvol_y30_lowVol$tbl
...
get_tbl_probLowBen <- function(df_benefit){
...
tbl_B_real_probLow_highVol <- get_tbl_probLowBen(df_benefit_y30_highVol)
tbl_B_real_probLow_midVol  <- get_tbl_probLowBen(df_benefit_y30_midVol)
tbl_B_real_probLow_lowVol  <- get_tbl_probLowBen(df_benefit_y30_lowVol)

tbl_B_real_probLow_highVol 
tbl_B_real_probLow_midVol  
tbl_B_real_probLow_lowVol  
...
get_tbl_probLowBen2 <- function(df_benefit){
...
tbl_B_real_probLow2_highVol <- get_tbl_probLowBen2(df_benefit_y30_highVol)
tbl_B_real_probLow2_midVol  <- get_tbl_probLowBen2(df_benefit_y30_midVol)
tbl_B_real_probLow2_lowVol  <- get_tbl_probLowBen2(df_benefit_y30_lowVol)



tbl_B_real_probLow2_highVol 
tbl_B_real_probLow2_midVol  
tbl_B_real_probLow2_lowVol  
