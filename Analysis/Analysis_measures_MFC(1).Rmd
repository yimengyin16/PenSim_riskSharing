...
- check cola_return policy
- CQ2 M2/3: make it into quintile groups [to discuss]
...
grpVals_SD_return <-
	...
	summarise(SD_return_pinf= Inf,
		        SD_return_q90 = quantile(SD_return, 0.90),
						SD_return_q75 = quantile(SD_return, 0.75),
						SD_return_q50 = quantile(SD_return, 0.50),
						SD_return_q25 = quantile(SD_return, 0.25),
						SD_return_q10 = quantile(SD_return, 0.10),
						SD_return_ninf= -Inf,
	) 
...
**Cost Q1, Measure 4 [MFC]** Distribution of PV ERC within eachpolicy
