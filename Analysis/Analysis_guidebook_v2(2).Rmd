...
## PV cost by quintile: guidebook v2

**Cost Q1, Present value of ERC over 15 years: median differences in 5 return groups** 
...
df_PVC_quintiles <-
  ...
  left_join(df_CAGR$df, by = "sim") %>% 
	mutate(ERC_PV_std          = 100 * ERC_PV / df_PVC_ptiles$baseline[df_PVC_ptiles$Percentile == "ptile50"],
		     ...
		     ERC_PV_std_diff     = ERC_PV - ERC_PV_baseline,
...
xlsx::write.xlsx2(tbl_pvERC_y15$df_value, file = paste0(dir_outputs, "tbl_pvERC_value.xlsx"), sheetName = "pvERC_15y")
xlsx::write.xlsx2(tbl_pvERC_y30$df_value, file = paste0(dir_outputs, "tbl_pvERC_value.xlsx"), sheetName = "pvERC_30y", append = TRUE)
...
## Volatility by quintile: guidebook v2
...
# Asset shock scenario 1: figures
...
# Asset shock scenario 2: trade-off
...
df_detMeasures %<>% 
	mutate(B_cohort_PV_26y = ifelse(runname == "hybrid_DB",     df_DC_shock_sum$B_cohort_PV_26y, B_cohort_PV_26y),
				 B_cohort_PV_26y = ifelse(runname == "hybrid_DB_met", df_DC_met_sum$B_cohort_PV_26y, B_cohort_PV_26y),
				 )
...
xlsx::write.xlsx2(df_detMeasures, file = paste0(dir_outputs, "tbl_detMeasures.xlsx"), sheetName = "detMeasures")
