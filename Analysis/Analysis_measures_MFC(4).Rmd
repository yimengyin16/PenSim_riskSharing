...
df_assetShock_plot <- 
  df_assetShock %>% 
	...
	mutate(SC_PR = SC / PR) %>% 
	select(runname, sim, year, ERC_PR, FR_MA, NC_PR, EEC_PR, SC_PR, cola_actual) %>% 
...
fig_shock_ERC1 <- 
  df_assetShock_plot %>% 
	...
	geom_line(size = 1) + 
	geom_point(size = 2) + 
	annotate("rect", xmin = 2, xmax = 3, ymin = -1, ymax = 1, fill = "red", size = 0, alpha = 0.04) +
	annotate("rect", xmin = 3, xmax = 6, ymin = -1, ymax = 1, fill = "yellow", size = 0, alpha = 0.04) +
...
df_benefit_det %>% 
	...
	geom_line(size = 1) + 
	geom_point(size = 2) + 
	annotate("rect", xmin = 2, xmax = 3, ymin = -Inf, ymax = Inf, fill = "red", size = 0, alpha = 0.04) +
	annotate("rect", xmin = 3, xmax = 6, ymin = -Inf, ymax = Inf, fill = "yellow", size = 0, alpha = 0.04) +
...
save_as_image(tab_1, path = here::here("Outputs_Analysis/tab_1.png"))
...
save_as_image(tab_2, path = here::here("Outputs_Analysis/tab_2.png"))
...
save_as_image(tab_3, path = here::here("Outputs_Analysis/tab_3.png"))
...
save_as_image(tab_4, path = here::here("Outputs_Analysis/tab_4.png"))
