...
xlsx::write.xlsx2(fig5_dist_pvERC_y15_all$data, file = paste0(dir_outputs, "data_fig5_dist.pvERC.xlsx"))
...
fig6_dist_ERCvol_y15_barplot2 <- 
  ...
  annotate("text", x = 3.5, y = 0.17, label = "Policies with modest adjustments to \ndefined-benefit plans") + 
	...
	annotate("text", x = 7.5, y = 0.17, label = "More-radical or more-complex\nrisk-sharing policies")	+
